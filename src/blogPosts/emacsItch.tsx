    ...
    <div className="flex dark:bg-everbg items-center p-3 flex-col gap-4 lg:w-3/4 md:w-3/4">
      ...
      <div className="flex flex-col gap-4 lg:w-1/2 md:w-1/2 sm:w-10/12 sm:p-3">
        ...
        <P>
          ...
          - I first knew about emacs formally before I heard about neovim and It was actually a video about how emacs is a superior editor.
        ...
        <P>
          ...
          Now that I have a better understanding of Vim, a feeling of missing out of having the "everything editor" nags me. To only have a text editor
          and a browser. To be as close to my code as possible and yet be able to listen to music. To allow myself to go down a rabbit hole that I could never
        ...
        <P>
          ...
          I think for one the reason I find it hard to try out emacs is that vim is very ergonomic. I mean when the ed,vi or vim author was building it they took into account
          of the qwerty keyboard real nice(in joey's voice, from friends)
          I do not ever want to leave that. I have contemplated on just using doom emacs but I feel like using doom emacs can be compared to someone with zero vim knowledge starting with lazyvim
          You will by default be bound to lazyvim without understanding the foundation of vim.
          Naval ravikant has some quote on this saying "it is better to be a guy who understands basic algebra but doesn't understand calculus than to be a guy who understands calculus but struggles with algrbra".
          You may think around this quote like "it has loopholes" but the deal is that foundations are very important with every technology.
        ...
        <P>
          ...
          Since most people in the emacs state that orgmode is one of the best part of it, I decided to setup neorg which is an emulation/ similar to orgmode I believe. This has somehow scratched
